  ...
  return (
    <div className="space-y-3">
      ...
      {([
        ...
        { id: 'mobilidade_reduzida', icon: 'fa-wheelchair',   color: '#0ea5e9', label: 'Mobilidade Reduzida', desc: 'Lugares acessíveis com dimensões, distância à entrada, vigilância e espaço para rampa.' },
