...
import {
  allExpenses, COLORS, filterByPeriod, buildAreaData, buildPieData, buildVehicleData,
  type Period,
} from './custosHelpers';
    ...
    <div className="animate-in fade-in duration-200">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative flex items-center">
            ...
            >
              ...
              {vehicleNames.map((name) => <option key={name} value={name}>{name}</option>)}
            </select>
      ...
      {totalEV > 0 && (
        <div className="grid grid-cols-2 gap-3 mb-4">
          {[
            { icon: 'fa-square-parking', label: 'Estacionamento',    value: totalParking },
            { icon: 'fa-charging-station', label: 'Carregamento EV', value: totalEV },
          ].map((item) => (
                        ...
                        {expense.vehicle && (
                          <>
                            ...
                            <span className="flex items-center gap-1 text-muted-foreground text-xs">
                              <i className="fas fa-car" aria-hidden="true" />{expense.vehicle}
                            </span>
                          </>
                        )}
                        {hasEV && (
