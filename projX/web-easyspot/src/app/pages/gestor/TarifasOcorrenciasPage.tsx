...
import { FaturacaoTab } from './components/FaturacaoTab';
...
export function TarifasOcorrenciasPage() {
  ...
  return (
    <div className="px-4 py-5 max-w-screen-xl mx-auto space-y-5">
      ...
      {tab === 'tarifas'     && <TarifasTab    onEdit={setEditTariff}   tariffs={gestorTariffs} />}
      {tab === 'ocorrencias' && (
        <OcorrenciasTab
      ...
      {tab === 'faturacao'   && <FaturacaoTab  billingRecords={gestorBillingRecords} />}
