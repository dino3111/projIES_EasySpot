...
SENSOR_FAULT_DEGRADED_PROBABILITY = float(
    os.getenv("SENSOR_FAULT_DEGRADED_PROBABILITY", "0.0000002")
)
SENSOR_FAULT_OFFLINE_PROBABILITY = float(
    os.getenv("SENSOR_FAULT_OFFLINE_PROBABILITY", "0.00000005")
)
SENSOR_FAULT_MAINTENANCE_PROBABILITY = float(
    os.getenv("SENSOR_FAULT_MAINTENANCE_PROBABILITY", "0.00000005")
)
