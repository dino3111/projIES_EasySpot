...
OCR_FAULT_PROBABILITY_PER_TICK = float(os.getenv("OCR_FAULT_PROBABILITY_PER_TICK", "0"))
OCR_ENTRY_PROBABILITY = float(os.getenv("OCR_ENTRY_PROBABILITY", "0.0005"))
OCR_EXIT_PROBABILITY = float(os.getenv("OCR_EXIT_PROBABILITY", "0.65"))
OCR_MIN_PARKING_SECONDS = float(os.getenv("OCR_MIN_PARKING_SECONDS", "300"))
OCR_MAX_PARKING_SECONDS = float(os.getenv("OCR_MAX_PARKING_SECONDS", "1800"))
...
SENSOR_FAULT_DEGRADED_PROBABILITY = float(
    os.getenv("SENSOR_FAULT_DEGRADED_PROBABILITY", "0")
)
SENSOR_FAULT_OFFLINE_PROBABILITY = float(
    os.getenv("SENSOR_FAULT_OFFLINE_PROBABILITY", "0")
)
SENSOR_FAULT_MAINTENANCE_PROBABILITY = float(
    os.getenv("SENSOR_FAULT_MAINTENANCE_PROBABILITY", "0")
)
...
P_OUT_OF_SERVICE_TO_OUT_OF_SERVICE = float(
    os.getenv("P_OUT_OF_SERVICE_TO_OUT_OF_SERVICE", "0.995")
)
P_OUT_OF_SERVICE_TO_FREE = float(os.getenv("P_OUT_OF_SERVICE_TO_FREE", "0.005"))
