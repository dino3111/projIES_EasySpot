...
INSERT INTO gate_events (
    id, park_id, gate_id, direction, event_type, state, previous_state, plate, reason, occurred_at, extra
)
VALUES
    -- Fórum Aveiro (AV1) entry: normal open/close
    (
        GEN_RANDOM_UUID(),
    ...
    -- Fórum Aveiro (AV1) entry: low-confidence OCR → blocked
    (
        GEN_RANDOM_UUID(),
        '4731819f-a806-5c1f-be8c-a478d4276840',
        'gate-4731819f-entry',
        ...
        '{"scenario": "ocr_failure", "confidence": 0.45}'
    ),
    (
        GEN_RANDOM_UUID(),
        '4731819f-a806-5c1f-be8c-a478d4276840',
    ...
    -- Fórum Aveiro (AV1) entry: hardware fault → recovery
    (
        GEN_RANDOM_UUID(),
        '4731819f-a806-5c1f-be8c-a478d4276840',
        'gate-4731819f-entry',
    ...
    -- Fórum Aveiro (AV1) exit: normal open/close
    (
        GEN_RANDOM_UUID(),
        '4731819f-a806-5c1f-be8c-a478d4276840',
        'gate-4731819f-exit',
    ...
    -- Glicínias Plaza (AV2) entry: normal open/close
    (
        GEN_RANDOM_UUID(),
    ...
    -- Glicínias Plaza (AV2) exit: blocked (unreadable plate)
    (
        GEN_RANDOM_UUID(),
        'd8085d8f-7aaa-5eb4-b47d-2e2fe79bfe43',
        'gate-d8085d8f-exit',
        ...
        '{"scenario": "ocr_failure", "ocrEventType": "ocr.plate.unreadable"}'
    ),
    (
        GEN_RANDOM_UUID(),
        'd8085d8f-7aaa-5eb4-b47d-2e2fe79bfe43',
    ...
    -- Europa Aveiro (LE1) entry: normal open/close
    (
        GEN_RANDOM_UUID(),
    ...
    -- Europa Aveiro (LE1) exit: normal open/close
    (
        GEN_RANDOM_UUID(),
        '070b4f4d-9a9e-5c4a-92bd-eae711ecb6b3',
        'gate-070b4f4d-exit',
    ...
    -- EasySpot EV Hub (EV1) entry: normal open/close
    (
        GEN_RANDOM_UUID(),
    ...
    -- EasySpot EV Hub (EV1) exit: normal open/close
    (
        GEN_RANDOM_UUID(),
        'ee000001-0000-0000-0000-000000000001',
        'gate-ee000001-exit',
