...
insert into public.alerts
    (id, parking_lot_id, parking_lot_name, type, severity, state,
     zone, spot_number, sensor_id, plate,
     description, photo_url, attributed_to, notes, resolved_at, created_at)
values
...
(
    ...
    'Veículo sem qualquer dístico de mobilidade reduzida estacionado no lugar MR-03 desde as 10h30. '
    'Não há nenhum passageiro com necessidade visível no veículo.',
...
(
    ...
    'Veículo a gasóleo estacionado no lugar de carregamento EV-07 há mais de 2 horas. '
    'O carregador está bloqueado para veículos elétricos.',
    null, 'Maria Silva',
    'Assistente do parque verificou no local — contacto com proprietário em curso.',
    null,
...
(
    ...
    'Veículo sem matrícula visível a bloquear completamente a saída de emergência do Piso -2. '
    'Situação perigosa — impede evacuação rápida.',
    null, 'Luís Pedro',
    null, null,
...
(
    ...
    'Veículo particular estacionado no lugar reservado para autocarro de equipa visitante.',
    null, 'Filipe Teixeira',
...
(
    ...
    'Veículo em dupla fila junto ao lugar A-04 a bloquear saída de dois outros veículos. '
    'Situação reportada às 13h00.',
    null, 'Maria Silva',
...
(
    ...
    'Veículo estacionado fora dos limites demarcados, ocupando parte do corredor de circulação.',
